/**
 * dsh-wallpaper-bg v0.2.0 — 浏览器半（单文件 client bundle）
 * =========================================================
...
window.__ModuleLoader__.load({
  ...
  factory(require) {
    ...
    var CSS_TEXT =
      ...
      '.wbg-seg-btn.wbg-active{background:var(--dsw-alias-brand-primary);color:#fff;border-color:transparent;}' +
      ...
      '.wbg-chip.wbg-active{background:var(--dsw-alias-brand-primary);color:#fff;border-color:transparent;}' +
